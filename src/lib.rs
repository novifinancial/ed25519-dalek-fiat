...
//! # let mut csprng = OsRng{};
//! # let keypair: Keypair = Keypair::generate(&mut csprng);
//! use ed25519_dalek_fiat::{Signature, Signer};
...
//! # fn main() {
//! # use rand::rngs::OsRng;
//! # use ed25519_dalek_fiat::{Keypair, Signature, Signer};
//! # let mut csprng = OsRng{};
//! # let keypair: Keypair = Keypair::generate(&mut csprng);
//! # let message: &[u8] = b"This is a test of the tsunami alert system.";
//! # let signature: Signature = keypair.sign(message);
...
//! use ed25519_dalek_fiat::{PublicKey, Verifier};
//! # let mut csprng = OsRng{};
//! # let keypair: Keypair = Keypair::generate(&mut csprng);
//! # let message: &[u8] = b"This is a test of the tsunami alert system.";
//! # let signature: Signature = keypair.sign(message);
...
//! # fn main() {
//! # use rand::rngs::OsRng;
//! # use ed25519_dalek_fiat::{Keypair, Signature, Signer, PublicKey};
//! use ed25519_dalek_fiat::{PUBLIC_KEY_LENGTH, SECRET_KEY_LENGTH, KEYPAIR_LENGTH, SIGNATURE_LENGTH};
//! # let mut csprng = OsRng{};
//! # let keypair: Keypair = Keypair::generate(&mut csprng);
//! # let message: &[u8] = b"This is a test of the tsunami alert system.";
//! # let signature: Signature = keypair.sign(message);
...
//! # use rand::rngs::OsRng;
//! # use ed25519_dalek_fiat::{Keypair, Signature, Signer, PublicKey, SecretKey, SignatureError};
//! # use ed25519_dalek_fiat::{PUBLIC_KEY_LENGTH, SECRET_KEY_LENGTH, KEYPAIR_LENGTH, SIGNATURE_LENGTH};
...
//! # fn main() {
//! # use rand::rngs::OsRng;
//! # use ed25519_dalek_fiat::{Keypair, Signature, Signer, Verifier, PublicKey};
